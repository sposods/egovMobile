...
CREATE TABLE COMTNMLTMD
  (
    ...
    MLTMD_CODE_ID		VARCHAR2(6),
    MLTMD_CODE			VARCHAR2(15),
    MLTMD_SJ			VARCHAR2(256),
    BROWSER_NM			VARCHAR2(128),
    CREAT_DT			DATE NOT NULL ,
    UPDT_DT				DATE NOT NULL ,
...
CREATE TABLE COMTNMMS
  (
    SN                     NUMBER(20,0) NOT NULL ,
    MBER_ID                VARCHAR2(20 ) NOT NULL ,
    TRNSMIS_NO             VARCHAR2(32 ),
    RECPTN_NO              VARCHAR2(32 ),
    MSSAGE_SJ		VARCHAR2(32 ) NOT NULL ,
    MSSAGE_CN		VARCHAR2(1000 ),
    MSSAGE_ID		VARCHAR2(52 ),
    RQESTER_RESULT_CODE_ID VARCHAR2(6 ),
    RQESTER_RESULT_CODE    VARCHAR2(15 ),
    TRNSMIS_RESULT_CODE_ID VARCHAR2(6 ),
    TRNSMIS_RESULT_CODE    VARCHAR2(15 ),
