 ...
 *   2024.05.02. 김수용          NSR 보안조치 (업로드 파일의 확장자 검사 메소드 추가)
 *
 * </pre>
 */
...
public class EgovMultimediaController {
    ...
    public String insertMultimedia(
        ...
        if (!files.isEmpty()) {
            ...
            boolean allowed = multimediaService.checkMultimediaFileExtension(_result);
            if(!allowed) {
            throw new EgovFileExtensionException(
            "File extension not allowed.","errors.file.extension.deny");
            }
