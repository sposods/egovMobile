 ...
 *   2024.05.02		김수용		NSR 보안조치 (임의의 JSP 파일 실행 차단)
 *   2024.05.02		김수용		NSR 보안조치 (임의의 설정파일 정보 유출 차단)
 *
 * </pre>
 */
@Controller
public class EgovMblQustnrRespondInfoController {
	...
	/**
	 * 설문템플릿을 적용한다.	(240502 NSR 보안조치 적용 : 임의의 JSP 파일 실행 차단)
	 * @param searchVO
	 * @param request
	 * @param commandMap
	 * @param model
	 ...
	 * @throws Exception
	 */
	 // 240610 NSR 보안조치 적용 (임의의 JSP 파일 실행 차단) - 미사용 메서드 EgovQustnrRespondInfoManageTemplate() 삭제, 미사용 EgovProperty.jsp 삭제
